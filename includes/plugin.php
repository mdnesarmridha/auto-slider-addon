...
final class Plugin {
	 ...
	 * @access private
	 * @static
	 * @var \Axxento_Addon\Plugin The single instance of the class.
	 */
	 ...
	 * @access public
	 * @static
	 * @return \Axxento_Addon\Plugin An instance of the class.
	 */
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__( 'Elementor Axxento Addon', 'elementor-test-addon' ) . '</strong>',
	 ...
	 * Fired by `elementor/init` action hook.
	 *
	 * @param \Elementor\elements_manager $widgets_manager Elementor widgets manager.
	 */
	...
	// 	$widgets_manager->register( new \Axxento_Addon\Widget_1() );
	// 	$widgets_manager->register( new \Axxento_Addon\Widget_2() );
	...
	// 	$controls_manager->register( new \Axxento_Addon\Control_1() );
	// 	$controls_manager->register( new \Axxento_Addon\Control_2() );
